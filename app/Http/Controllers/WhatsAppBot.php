...
class WhatsAppBot
{
  ...
  public function __construct()
  {
    ...
    ob_end_clean();
    file_put_contents('log/input_requests.log', $input . PHP_EOL, FILE_APPEND);
  ...
  public function sendRequest($method, $data)
  {
    ...
    file_put_contents('log/requests.log', $response . PHP_EOL, FILE_APPEND);
  }
}
